...
//        return "/userInfo/find_employee.xhtml?faces-redirect=true";
    ...
    public void findPatientWithDate(){ // for check-in
        DbDAO dao = new DbDAO();
        findList = dao.findPatientWithDate(signinBean.locationId, DbDAO.getTodayMillisecondsWithoutTime()+86400000, findId, findName, dateToDouble(findDoB));
    ...
    public void findAllPatient(){ // for check-in
        DbDAO dao = new DbDAO();
        findList = dao.findPatient(signinBean.locationId, null, null, null);
