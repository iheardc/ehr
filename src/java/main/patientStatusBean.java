...
public class patientStatusBean implements Serializable {
    ...
    private List<DynamicInfo> findCKIList; // Check-In 
    ...
    public void findDynaPatient() {
        ...
        findCKIList = new ArrayList<DynamicInfo>();
        ...
        if (patientStatus.equals("ALL")){
            ...
            for (DynamicInfo dy : dList) {
                ...
                else if (DbDAO.DYNAMIN_DATA[8].equals(dy.status)) {
                    findCKOList.add(dy);
                }
            }
        ...
        isShowCKITable = findCKIList.size() > 0;
...
//        return "/userInfo/find_employee.xhtml?faces-redirect=true";
    ...
    public List<DynamicInfo> getFindCKIList() {
        return findCKIList;
    }

    public void setFindCKIList(List<DynamicInfo> findCKIList) {
        this.findCKIList = findCKIList;
    }
    ...
    public boolean isIsShowCKITable() {
        return isShowCKITable;
    }

    public void setIsShowCKITable(boolean isShowCKITable) {
        this.isShowCKITable = isShowCKITable;
    }
